...
# ВАЖНО
## Для работы кассы требуются рассширение для PHP
- ### cURL
- ### SimpleXML
### Установить их можно через SHELL клиент (если у вас VDS или VPS), если у вас хостинг то посмотрите как включить рассширение для PHP 
...
```
- ### Если у вас хостинг то советую обратиться в тех поддержку хостинга или документацию хостинга как установить рассширение (обычно можно даже заглянуть в гугл и посмотреть как включить рассширение)
# Установка кассы
...
- Настройка валюты кассы (для выборки валюты кассы вам нужно в самой FoxyPay кассе выбрать валюту)
<p align="center">
 <img width="400px" src="./foxypay_payments.png" alt="UNI"/>
</p>
ЕСЛИ У ВАС УКАЗАНА ВАЛЮТА САЙТА USD,UAH,EUR ТО ВАЛЮТА САЙТА ДОЛЖНА БЫТЬ ТАКАЯ ЖЕ КАК И ВАЛЮТА КАССЫ
...
- Пример: Валюта сайта: RUB, то можно использовать валюту кассы такие как: USD,EUR,UAH
